...
nurons = 1000;
[H1,~]=myelm(data{1},label,neurons, 'sigmoid');
[H2,~]=myelm(data{2},label,neurons, 'sigmoid');
clear data;
data{1} = H1;
data{2} = H2;
...
fprintf('======================================\n');
fprintf('running MMSC for BBC Sport\n');
fprintf('neurons =%d\n',nurons);
...
save('./result/MMSC_BBCSport.mat','pr','neurons_i','ACC_array_avg','ACC_array_std','nmi_array_avg','nmi_array_std','Purity_array_avg','Purity_array_std');
toc;
